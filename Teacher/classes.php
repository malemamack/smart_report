    ...
    <?php 
     ...
     <a href="index.php" class="btn btn-light">Go Back</a>
           ...
           <div class="table-responsive">
              <table class="table table-bordered mt-3 n-table" style="background-color: rgba(255, 255, 255, 0.7); font-weight: 600; font-size:15px;  width:50%; justify-self: center; height: 10px;">
                <thead>
                  <tr>
                    <th scope="col">#</th>
